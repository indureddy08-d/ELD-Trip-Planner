...
export const PRESETS = [
  {
    id: "short",
    label: "Short Haul",
    description: "~230 mi · same-day · no breaks needed",
    form: {
      current_location:         "Dallas, TX",
      pickup_location:          "Fort Worth, TX",
      dropoff_location:         "Austin, TX",
      current_cycle_used_hours: "4",
      driver_name:              "James R. Mitchell",
      carrier_name:             "Lone Star Freight Solutions LLC",
      main_office_address:      "2500 Stemmons Fwy, Dallas, TX 75207",
      vehicle_numbers:          "Unit 4821 / Trailer 9034",
      co_driver_name:           "",
      shipper_and_commodity:    "Texas Office Supply Co. — Office Paper, Palletized",
    },
  },
  {
    id: "break",
